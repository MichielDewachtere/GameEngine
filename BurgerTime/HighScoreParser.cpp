...
void HighScoreParser::UpdateHighScores(const std::string& playerName, int score)
{
...
std::vector<std::pair<std::string, int>> HighScoreParser::GetTopFive()
{
...
void HighScoreParser::GenerateDefaultJson(const std::string& filename)
{
    using namespace rapidjson;
