...
real::GameObject* LevelManager::ParseLevel(real::Scene& pScene, const std::string& fileName)
{
...
LevelManager::GameObjectPtrs LevelManager::GetPlayerPtrs()
{
    //if (m_PlayerPtrs.empty())
    //    real::SceneManager::GetActiveScene()

    return m_PlayerPtrs;
}

void LevelManager::ParseIngredient(real::GameObject* pGameObject, const rapidjson::Document& document,
